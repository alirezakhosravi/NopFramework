...
namespace Nop.Services.Localization
{
    ...
    public partial class LocalizationService : ILocalizationService
    {
        ...
        /// </summary>
        /// <param name="languageId">Language identifier</param>
        /// <param name="loadPublicLocales">A value indicating whether to load data (if "false", then for admin area only. If null, then load all locales. We use it for performance optimization of the site startup</param>
        /// <returns>Locale string resources</returns>
            ...
            where TSettings : ISettings, new()
        {
            ...
            //we do not support localized settings
