...
namespace Nop.Core.Domain.Security
{
    ...
    {
        /// <summary>
        /// Gets or sets a value indicating whether enable to use SSL
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether XSRF protection for site area should be enabled
        /// </summary>
        /// <value><c>true</c> if enable xsrf protection for site; otherwise, <c>false</c>.</value>
        public bool EnableXsrfProtectionForSite { get; set; }
    }
}