...
{
    /// <summary>
    /// Represents a filter attribute that enables anti-forgery feature for the site
    /// </summary>
    public class PublicAntiForgeryAttribute : TypeFilterAttribute
    {
        ...
        /// <summary>
        /// Represents a filter that enables anti-forgery feature for the site
        /// </summary>
        private class PublicAntiForgeryFilter : ValidateAntiforgeryTokenAuthorizationFilter
        {
            ...
            protected override bool ShouldValidate(AuthorizationFilterContext context)
            {
                ...
                if (!_securitySettings.EnableXsrfProtectionForSite)
                    return false;
